...
#--------------------
#Bagging - Create random forest with all variables (m=p=29)
set.seed(42)
n = nrow(train)

bag_20 = randomForest(TripCount ~., data = train, ntree=20, mtry=18)
print(bag_20)


bag_50 = randomForest(TripCount ~., data = train, ntree=50, mtry=18)
print(bag_50)

bag_200 = randomForest(TripCount ~., data = train, ntree=200, mtry=18)
print(bag_200)
plot(bag_200)
varImpPlot(bag_200)
...
bag_val_4 = randomForest(TripCount ~., data = train, xtest = pred, ytest = predY, ntree=4, mtry=20)
print(bag_val_4)
plot(bag_val_4)

bag_val_150 = randomForest(TripCount ~., data = train, xtest = pred, ytest = predY, ntree=150, mtry=20)
print(bag_val_150)
plot(bag_val_150)
